    ...
    <div className="max-w-md mx-auto bg-white shadow-sm border border-gray-200 rounded-lg p-6 space-y-4">
      ...
      <form onSubmit={onSubmit} className="grid gap-3">
        <label className="grid gap-1 text-sm">
          <span>Full name</span>
          <input className="border rounded-md px-3 py-2" value={fullName} onChange={(e) => setFullName(e.target.value)} type="text" />
        </label>
        <label className="grid gap-1 text-sm">
          <span>Email</span>
        ...
        <button className="inline-flex items-center rounded-md bg-blue-600 text-white px-4 py-2 hover:bg-blue-700" type="submit">Create Account</button>
